...
local JSON = { 'clave', 'costol', 'proveedor' }
...
local function records()
    ...
    local clause = 'WHERE datos.clave == proveedores.clave AND desc NOT LIKE "VV%"'
    local qry = string.format('SELECT datos.clave, costol, proveedor FROM datos, proveedores %s', clause)
